        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">REGISTRO DE VENTAS DE SEGUROS A PERSONA NATURAL</h2>
                </div>
                <div class="card-body">
                    <form method="POST" action="registro_1.php">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="edad">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row m-b-55">
                            <div class="name">Nivel de ingresos</div>
                            <div class="value">
                                    <div class="col-9">
                                        <div class="input-group-desc">
